			...
			<div class="authentication-inner">
				...
				<div class="card">
					<div class="card-body">
						...
						<!-- /Logo -->
						<h4 class="mb-2">Atualização de Usuário 🚀</h4>
						<p class="mb-4">Realize aqui a atualização do seu cadastro!</p>
						...
						<form id="formAuthentication" class="mb-3"
							action="alterarUsuario" method="POST">
							<input type="hidden" name="id" id="id" value="${usuario.id}">
							<div class="mb-3">
								<label for="username" class="form-label">Nome:</label> <input
									type="text" class="form-control" id="username" name="nome"
									placeholder="Insira o seu nome" autofocus value="${usuario.nome}" />
							</div>
							<div class="mb-3">
								<label for="email" class="form-label">Email</label> <input
									type="text" class="form-control" id="email" name="email"
									placeholder="Insira o seu email" value="${usuario.email}" />
							</div>
							...
							<div class="mb-3 form-password-toggle">
								<label class="form-label" for="password">Senha
									confirmada:</label>
								<div class="input-group input-group-merge">
									<input type="password" id="password" class="form-control"
										name="senha02"
							...
							<div class="mb-3">
								<button class="btn btn-primary d-grid w-100">Salvar</button>
						</form>

						<p class="text-center">
							<span>Deseja desistir de atualizar?</span> <a
								href="cadastrarUsuario"> <span>Clique aqui!</span>
							</a>
						</p>
					</div>
				</div>
