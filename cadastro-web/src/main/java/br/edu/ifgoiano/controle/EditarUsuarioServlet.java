...
public class EditarUsuarioServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String id = req.getParameter("usuarioId"),nome = req.getParameter("nome"), email = req.getParameter("email"), senha01 = req.getParameter("senha01"), senha02 = req.getParameter("senha02");
		if( (senha01.equals(senha02)) && !senha01.isBlank()  ) {
			Usuario usuario = new Usuario();
			//Redirecionar o usuário para a tela de login
			resp.sendRedirect("usuarioListagem.jsp");
